...
if ($TargetMAC -eq 'FFFFFFFFFFFF' -or $TargetMAC -eq 'FF:FF:FF:FF:FF:FF') {

     Write-Output "Sending Magic Packet to all neighbors."
     ...
     Write-Output "Sending Magic Packet to specific Mac : $TargetMAC"
